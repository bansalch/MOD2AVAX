...
export default function HomePage() {
  ...
  const contractAddress = "0x803aa66B1d615b048c22dB8CE89931517CB215d6";
  ...
  return (
    <main className="container">
      ...
      <div>
        <button onClick={showBalance}>Contract Balance</button>
      </div>

      <lable><strong>Enter the Amount: </strong></lable>
      <input
